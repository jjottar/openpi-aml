...
- ADLS Gen2 storage account with hierarchical namespace enabled. In the following examples and AzureML yaml scripts, the storage account and used container are both called "libero". 
