...
--set compute=nabk-d16d-v4 \
--set environment="azureml:openpi0-env:2" \
--set outputs.ASSETS_BASE.path="azureml://datastores/nora_datasets/paths/pi0_fast_custom/noraabk/so101-goat-picking-v1/" \
